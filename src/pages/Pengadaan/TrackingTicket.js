...
class TrackingMutasi extends Component {
    ...
    render() {
        const {isOpen, dropOpen, dropOpenNum, detail, alert, newMut, detailTrack} = this.state
                        ...
                        <div className={style.backgroundLogo}>
                            <div className={style.bodyDashboard}>
                                ...
                                <div className={style.headMaster}>
                                    <div className={style.titleDashboard}>Tracking Pengadaan Asset</div>
                                </div>
                                <div>
                                            ...
                                            return (
                                                trackIo.length === 0 ? (
                                                    ...
                                                    <Row className="footCard mb-3 mt-3">
                                                        <Col md={12} xl={12}>
                                                            <Button className="btnSell" color="primary" onClick={() => {this.getDetailTrack(item.no_pengadaan)}}>Lacak</Button>
                                                        </Col>
                                                    </Row>
                                                </div>
                                                )
