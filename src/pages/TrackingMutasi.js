                            ...
                            <Card className="cardCollap">
                                <CardBody>
                                    ...
                                    {this.state.tipeCol === 'submit' ? (
                                        <div>Tanggal submit : {detailMut[0] === undefined ? '' : moment(detailMut[0].tanggalDis === null ? detailMut[0].createdAt : detailMut[0].tanggalDis).locale('idn').format('DD MMMM YYYY ')}</div>
                                    ) : (
                                        <div></div>
                                    )}
